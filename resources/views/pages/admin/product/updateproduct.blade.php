      ...
      <div class="col-span-10">
        <div class="border rounded bg-dashboard-bg">
          <div class="border-b rounded-b">
            <h1 class="text-lg font-bold py-3 px-3">Update Product</h1>
          </div>
          <div class="py-9">
            <div class="border shadow bg-white rounded py-4 px-4 max-w-2xl m-auto">
              <form action="{{url('/admin/dashboard/updateProduct')}}/{{$product->id}}" method="POST"
                ...
                <div class="grid grid-cols-12 gap-6">
                  <div class="col-span-12">
                    ...
                    <input type="text" name="product_name"
                      ...
                      placeholder="New Product Name" value="{{$product->product_name}}">
                  </div>
                  <div class="col-span-12">
                    ...
                    class="ckeditor form-control">{!! html_entity_decode($product->product_description)!!}</textarea>
                  </div>
                  <div class="col-span-12">
                    ...
                    <input class="form-control
                      ...
                      name="product_image" type="file" id="formFile" value="{{$product->product_image}}">
                  </div>
                  ...
                  <div class="col-span-12 sm:col-span-4 lg:col-span-4">
                    ...
                    <select id="country" name="subcategory_id" autocomplete="country-name"
                      class="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-primary focus:border-primary sm:text-sm">
                      <option value={{$product->subcategory_id}}>{{$subcategory_name}}</option>
                  ...
                  <div class="col-span-12 sm:col-span-4 lg:col-span-4">
                    ...
                    <select id="country" name="childcategory_id" autocomplete="country-name"
                      class="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-primary focus:border-primary sm:text-sm">
                      <option value="{{$product->child_category_id}}">{{$childcategory_name}}</option>
