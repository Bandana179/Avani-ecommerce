            ...
            <div class="border bg-white rounded py-4 px-4">
              <div class="grid grid-cols-12 gap-6">
                <div class="col-span-12 md:col-span-4">
                  <form action="/admin/dashboard/add-childcategory" method="Post">
                    @csrf
                    <div>
                      <label for="" class="text-sm font-medium text-gray-700">Child Category
                        Name</label>
                      <input type="text" name="child_category_name" class="mt-1 focus:ring-primary focus:border-primary block w-full
                        shadow-sm
                        sm:text-sm border-gray-300 rounded-md" placeholder="New Child Category" required>
                    </div>
                    <div class="mt-4">
                      <label for="" class="text-sm font-medium text-gray-700">Main Category
                        *</label>
                    ...
                    <div class="mt-4">
                      <label for="" class="text-sm font-medium text-gray-700">Sub Category
                        Name*</label>
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                              <tr>
                                <td class="px-6 py-4 whitespace-nowrap">
                                  <div class="flex items-center">
                                    <div class="text-base text-gray-500">
                                      {{ $child->subcategory->sub_category_name }}
                                    </div>
                                  </div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                  <div class="flex items-center">
                                    <div class="text-base text-gray-500">
                                      {{ $child->child_category_name }}</div>
                                  </div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                  <a href="{{ url('/admin/dashboard/edit-childcategory') }}/{{ $child->id }}"
                                    class="text-indigo-600 font-bold text-xl hover:text-indigo-900 px-1"><i
                                      class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
                                  <a href="{{ url('/admin/dashboard/delete-childcategory') }}/{{ $child->id }}"
